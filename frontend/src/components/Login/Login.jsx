...
const navigate = useNavigate()
  ...
  const handleSubmit = async (e) => {
    e.preventDefault()
    await axios.post(`${server}/user/login-user`, { email, password }, { withCredentials: true })//  to activate the cookie we have to pass the withCredentials:true
      .then((res) => {
  ...
  return (
    <div className='min-h-screen bg-gray-500 flex flex-col justify-center py-12 sm:px-6 lg:px-8 '>
      <div className="sm:mx-auto sm:w-full sm:max-w-md ">
        <h2 className='mt-6 text-center text-3xl font-extrabold text-slate-200'>Login to your account</h2>
      </div>
